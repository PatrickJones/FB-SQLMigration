...
namespace NuLibrary.Migration.Test.EF
{
    ...
    public partial class aspnerdbUnitTestEntities : DbContext
    {
        public aspnerdbUnitTestEntities()
            : base("name=aspnerdbUnitTestEntities")
        {
        }
        ...
        public virtual DbSet<help_ImageData> help_ImageData { get; set; }
        public virtual DbSet<help_Images> help_Images { get; set; }
        public virtual DbSet<help_ModuleOrder> help_ModuleOrder { get; set; }
        public virtual DbSet<help_Modules> help_Modules { get; set; }
        public virtual DbSet<insulet_Contacts> insulet_Contacts { get; set; }
        public virtual DbSet<insulet_LocationRegions> insulet_LocationRegions { get; set; }
        public virtual DbSet<insulet_People> insulet_People { get; set; }
        public virtual DbSet<insulet_PeopleLocations> insulet_PeopleLocations { get; set; }
        public virtual DbSet<insulet_PeopleRegions> insulet_PeopleRegions { get; set; }
        public virtual DbSet<insulet_PeopleRoles> insulet_PeopleRoles { get; set; }
        public virtual DbSet<insulet_Regions> insulet_Regions { get; set; }
        public virtual DbSet<insulet_Reports> insulet_Reports { get; set; }
        public virtual DbSet<Location> Locations { get; set; }
        public virtual DbSet<Policy_Docs> Policy_Docs { get; set; }
        public virtual DbSet<Server_Settings> Server_Settings { get; set; }
        public virtual DbSet<site_IPTrackedEvents> site_IPTrackedEvents { get; set; }
        public virtual DbSet<Site> Sites { get; set; }
        public virtual DbSet<stats_PageRequests> stats_PageRequests { get; set; }
        ...
        public virtual DbSet<users_EmailConfirmations> users_EmailConfirmations { get; set; }
        public virtual DbSet<users_PasswordConfirmations> users_PasswordConfirmations { get; set; }
        public virtual DbSet<users_Sessions> users_Sessions { get; set; }
        public virtual DbSet<users_Settings> users_Settings { get; set; }
        public virtual DbSet<users_SmarterMailAccounts> users_SmarterMailAccounts { get; set; }
        public virtual DbSet<webpages_Membership> webpages_Membership { get; set; }
        public virtual DbSet<webpages_OAuthMembership> webpages_OAuthMembership { get; set; }
        public virtual DbSet<webpages_Roles> webpages_Roles { get; set; }
        public virtual DbSet<aspnet_Users_WithFreeUser> aspnet_Users_WithFreeUser { get; set; }
        public virtual DbSet<clinipro_Users_WithFreeUser> clinipro_Users_WithFreeUser { get; set; }
        public virtual DbSet<Membership_Revert> Membership_Revert { get; set; }
        public virtual DbSet<User_Accounts> User_Accounts { get; set; }
        public virtual DbSet<CorporationsView> CorporationsViews { get; set; }
        public virtual DbSet<OPP_Logins> OPP_Logins { get; set; }
        ...
        public virtual int CreateFullAdminUser(Nullable<int> dP_SiteId)
        {
            var dP_SiteIdParameter = dP_SiteId.HasValue ?
                new ObjectParameter("DP_SiteId", dP_SiteId) :
                new ObjectParameter("DP_SiteId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CreateFullAdminUser", dP_SiteIdParameter);
        }
    
        public virtual int getEmail(string patientID)
        {
            var patientIDParameter = patientID != null ?
                new ObjectParameter("PatientID", patientID) :
                new ObjectParameter("PatientID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("getEmail", patientIDParameter);
        }
    
        public virtual int GetPatientKey(string userName)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetPatientKey", userNameParameter);
        }
    
        public virtual int GetUserGroup(string userName)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetUserGroup", userNameParameter);
        }
    
        public virtual int GetUserType(string userName)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetUserType", userNameParameter);
        }
    
        public virtual int Nu_Membership_Revert_Insert(Nullable<System.Guid> userId, string password, Nullable<int> passwordFormat, string passwordSalt, string passwordQuestion, string passwordAnswer, Nullable<bool> disableRevert)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
            ...
            var disableRevertParameter = disableRevert.HasValue ?
                new ObjectParameter("DisableRevert", disableRevert) :
                new ObjectParameter("DisableRevert", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Nu_Membership_Revert_Insert", userIdParameter, passwordParameter, passwordFormatParameter, passwordSaltParameter, passwordQuestionParameter, passwordAnswerParameter, disableRevertParameter);
        }
    
        public virtual int Nu_Membership_Revert_Update(Nullable<System.Guid> userId, string password, Nullable<int> passwordFormat, string passwordSalt, string passwordQuestion, string passwordAnswer, Nullable<bool> disableRevert)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Nu_Membership_Revert_Update", userIdParameter, passwordParameter, passwordFormatParameter, passwordSaltParameter, passwordQuestionParameter, passwordAnswerParameter, disableRevertParameter);
        }
