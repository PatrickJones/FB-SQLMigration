...
namespace NuLibrary.Migration.Test.EF
{
    ...
    public partial class UnitTestEntities : DbContext
    {
        ...
        public virtual DbSet<AdminQueries_Test> AdminQueries_Test { get; set; }
        public virtual DbSet<aspnet_Applications_Test> aspnet_Applications_Test { get; set; }
        public virtual DbSet<aspnet_Paths_Test> aspnet_Paths_Test { get; set; }
        public virtual DbSet<aspnet_PersonalizationAllUsers_Test> aspnet_PersonalizationAllUsers_Test { get; set; }
        public virtual DbSet<aspnet_PersonalizationPerUser_Test> aspnet_PersonalizationPerUser_Test { get; set; }
        public virtual DbSet<aspnet_Profile_Test> aspnet_Profile_Test { get; set; }
        public virtual DbSet<aspnet_Roles_Test> aspnet_Roles_Test { get; set; }
        public virtual DbSet<aspnet_SchemaVersions_Test> aspnet_SchemaVersions_Test { get; set; }
        public virtual DbSet<aspnet_Users_Test> aspnet_Users_Test { get; set; }
        public virtual DbSet<aspnet_WebEvent_Events_Test> aspnet_WebEvent_Events_Test { get; set; }
        public virtual DbSet<clinipro_Users_Test> clinipro_Users_Test { get; set; }
        public virtual DbSet<Corporations_Test> Corporations_Test { get; set; }
        public virtual DbSet<FirebirdConnections_Test> FirebirdConnections_Test { get; set; }
        public virtual DbSet<help_ImageData_Test> help_ImageData_Test { get; set; }
        public virtual DbSet<help_Images_Test> help_Images_Test { get; set; }
        public virtual DbSet<help_ModuleOrder_Test> help_ModuleOrder_Test { get; set; }
        public virtual DbSet<help_Modules_Test> help_Modules_Test { get; set; }
        public virtual DbSet<insulet_Contacts_Test> insulet_Contacts_Test { get; set; }
        public virtual DbSet<insulet_LocationRegions_Test> insulet_LocationRegions_Test { get; set; }
        public virtual DbSet<insulet_People_Test> insulet_People_Test { get; set; }
        public virtual DbSet<insulet_PeopleLocations_Test> insulet_PeopleLocations_Test { get; set; }
        public virtual DbSet<insulet_PeopleRegions_Test> insulet_PeopleRegions_Test { get; set; }
        public virtual DbSet<insulet_PeopleRoles_Test> insulet_PeopleRoles_Test { get; set; }
        public virtual DbSet<insulet_Regions_Test> insulet_Regions_Test { get; set; }
        public virtual DbSet<insulet_Reports_Test> insulet_Reports_Test { get; set; }
        public virtual DbSet<Locations_Test> Locations_Test { get; set; }
        public virtual DbSet<Policy_Docs_Test> Policy_Docs_Test { get; set; }
        public virtual DbSet<Server_Settings_Test> Server_Settings_Test { get; set; }
        public virtual DbSet<site_IPTrackedEvents_Test> site_IPTrackedEvents_Test { get; set; }
        public virtual DbSet<Sites_Test> Sites_Test { get; set; }
        public virtual DbSet<stats_PageRequests_Test> stats_PageRequests_Test { get; set; }
        public virtual DbSet<subs_Adjustments_Test> subs_Adjustments_Test { get; set; }
        public virtual DbSet<subs_CheckPayments_Test> subs_CheckPayments_Test { get; set; }
        public virtual DbSet<subs_Gaps_Test> subs_Gaps_Test { get; set; }
        public virtual DbSet<subs_PayPalPayments_Test> subs_PayPalPayments_Test { get; set; }
        public virtual DbSet<subs_Subscriptions_Test> subs_Subscriptions_Test { get; set; }
        public virtual DbSet<subs_Trials_Test> subs_Trials_Test { get; set; }
        public virtual DbSet<Table_1_Test> Table_1_Test { get; set; }
        public virtual DbSet<UserProfile_Test> UserProfile_Test { get; set; }
        public virtual DbSet<users_EmailConfirmations_Test> users_EmailConfirmations_Test { get; set; }
        public virtual DbSet<users_PasswordConfirmations_Test> users_PasswordConfirmations_Test { get; set; }
        public virtual DbSet<users_Sessions_Test> users_Sessions_Test { get; set; }
        public virtual DbSet<users_Settings_Test> users_Settings_Test { get; set; }
        public virtual DbSet<users_SmarterMailAccounts_Test> users_SmarterMailAccounts_Test { get; set; }
        public virtual DbSet<webpages_Membership_Test> webpages_Membership_Test { get; set; }
        public virtual DbSet<webpages_OAuthMembership_Test> webpages_OAuthMembership_Test { get; set; }
        public virtual DbSet<webpages_Roles_Test> webpages_Roles_Test { get; set; }
        public virtual DbSet<aspnet_Membership_Test> aspnet_Membership_Test { get; set; }
        public virtual DbSet<aspnet_Users_WithFreeUser_Test> aspnet_Users_WithFreeUser_Test { get; set; }
        public virtual DbSet<clinipro_Users_WithFreeUser_Test> clinipro_Users_WithFreeUser_Test { get; set; }
        public virtual DbSet<Membership_Revert_Test> Membership_Revert_Test { get; set; }
        public virtual DbSet<User_Accounts_Test> User_Accounts_Test { get; set; }
        ...
        public virtual DbSet<vw_payments_PayPal> vw_payments_PayPal { get; set; }
        public virtual DbSet<vw_subs_Payments> vw_subs_Payments { get; set; }
        ...
        public virtual int aspnet_Nu_CliniProUsers_WithFreeUser_Insert(Nullable<System.Guid> userId, string cliniProID, Nullable<int> cPSiteId, Nullable<System.Guid> createdBy, Nullable<bool> mustChangePW, Nullable<bool> isApproved, Nullable<int> loginCount, Nullable<bool> isFreeUser)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
    
            var cliniProIDParameter = cliniProID != null ?
                new ObjectParameter("CliniProID", cliniProID) :
                new ObjectParameter("CliniProID", typeof(string));
    
            var cPSiteIdParameter = cPSiteId.HasValue ?
                new ObjectParameter("CPSiteId", cPSiteId) :
                new ObjectParameter("CPSiteId", typeof(int));
    
            var createdByParameter = createdBy.HasValue ?
                new ObjectParameter("CreatedBy", createdBy) :
                new ObjectParameter("CreatedBy", typeof(System.Guid));
    
            var mustChangePWParameter = mustChangePW.HasValue ?
                new ObjectParameter("MustChangePW", mustChangePW) :
                new ObjectParameter("MustChangePW", typeof(bool));
    
            var isApprovedParameter = isApproved.HasValue ?
                new ObjectParameter("IsApproved", isApproved) :
                new ObjectParameter("IsApproved", typeof(bool));
    
            var loginCountParameter = loginCount.HasValue ?
                new ObjectParameter("LoginCount", loginCount) :
                new ObjectParameter("LoginCount", typeof(int));
    
            var isFreeUserParameter = isFreeUser.HasValue ?
                new ObjectParameter("IsFreeUser", isFreeUser) :
                new ObjectParameter("IsFreeUser", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("aspnet_Nu_CliniProUsers_WithFreeUser_Insert", userIdParameter, cliniProIDParameter, cPSiteIdParameter, createdByParameter, mustChangePWParameter, isApprovedParameter, loginCountParameter, isFreeUserParameter);
        }
    
        public virtual int aspnet_Nu_CliniProUsers_WithFreeUser_Update(Nullable<System.Guid> userId, string cliniProID, Nullable<int> cPSiteId, Nullable<System.Guid> createdBy, Nullable<bool> mustChangePW, Nullable<bool> isApproved, Nullable<int> loginCount, Nullable<bool> isFreeUser)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("aspnet_Nu_CliniProUsers_WithFreeUser_Update", userIdParameter, cliniProIDParameter, cPSiteIdParameter, createdByParameter, mustChangePWParameter, isApprovedParameter, loginCountParameter, isFreeUserParameter);
        }
    
        public virtual int aspnet_Nu_Membership_Insert(Nullable<System.Guid> applicationId, Nullable<System.Guid> userId, string password, Nullable<int> passwordFormat, string passwordSalt, string mobilePIN, string email, string loweredEmail, string passwordQuestion, string passwordAnswer, Nullable<bool> isApproved, Nullable<bool> isLockedOut, Nullable<System.DateTime> lastLoginDate, Nullable<System.DateTime> lastPasswordChangedDate, Nullable<System.DateTime> lastLockoutDate, Nullable<System.DateTime> createDate, Nullable<int> failedPasswordAttemptCount, Nullable<System.DateTime> failedPasswordAttemptWindowStart, Nullable<int> failedPasswordAnswerAttemptCount, Nullable<System.DateTime> failedPasswordAnswerAttemptWindowStart, string comment, Nullable<bool> isTemp)
        {
            ...
            var mobilePINParameter = mobilePIN != null ?
                new ObjectParameter("MobilePIN", mobilePIN) :
                new ObjectParameter("MobilePIN", typeof(string));
            ...
            var failedPasswordAnswerAttemptWindowStartParameter = failedPasswordAnswerAttemptWindowStart.HasValue ?
                new ObjectParameter("FailedPasswordAnswerAttemptWindowStart", failedPasswordAnswerAttemptWindowStart) :
                new ObjectParameter("FailedPasswordAnswerAttemptWindowStart", typeof(System.DateTime));
    
            var commentParameter = comment != null ?
                new ObjectParameter("Comment", comment) :
                new ObjectParameter("Comment", typeof(string));
    
            var isTempParameter = isTemp.HasValue ?
                new ObjectParameter("IsTemp", isTemp) :
                new ObjectParameter("IsTemp", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("aspnet_Nu_Membership_Insert", applicationIdParameter, userIdParameter, passwordParameter, passwordFormatParameter, passwordSaltParameter, mobilePINParameter, emailParameter, loweredEmailParameter, passwordQuestionParameter, passwordAnswerParameter, isApprovedParameter, isLockedOutParameter, lastLoginDateParameter, lastPasswordChangedDateParameter, lastLockoutDateParameter, createDateParameter, failedPasswordAttemptCountParameter, failedPasswordAttemptWindowStartParameter, failedPasswordAnswerAttemptCountParameter, failedPasswordAnswerAttemptWindowStartParameter, commentParameter, isTempParameter);
        }
    
        public virtual int aspnet_Nu_Membership_Update(Nullable<System.Guid> applicationId, Nullable<System.Guid> userId, string password, Nullable<int> passwordFormat, string passwordSalt, string mobilePIN, string email, string loweredEmail, string passwordQuestion, string passwordAnswer, Nullable<bool> isApproved, Nullable<bool> isLockedOut, Nullable<System.DateTime> lastLoginDate, Nullable<System.DateTime> lastPasswordChangedDate, Nullable<System.DateTime> lastLockoutDate, Nullable<System.DateTime> createDate, Nullable<int> failedPasswordAttemptCount, Nullable<System.DateTime> failedPasswordAttemptWindowStart, Nullable<int> failedPasswordAnswerAttemptCount, Nullable<System.DateTime> failedPasswordAnswerAttemptWindowStart, string comment, Nullable<bool> isTemp)
        {
            var applicationIdParameter = applicationId.HasValue ?
                new ObjectParameter("ApplicationId", applicationId) :
                new ObjectParameter("ApplicationId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("aspnet_Nu_Membership_Update", applicationIdParameter, userIdParameter, passwordParameter, passwordFormatParameter, passwordSaltParameter, mobilePINParameter, emailParameter, loweredEmailParameter, passwordQuestionParameter, passwordAnswerParameter, isApprovedParameter, isLockedOutParameter, lastLoginDateParameter, lastPasswordChangedDateParameter, lastLockoutDateParameter, createDateParameter, failedPasswordAttemptCountParameter, failedPasswordAttemptWindowStartParameter, failedPasswordAnswerAttemptCountParameter, failedPasswordAnswerAttemptWindowStartParameter, commentParameter, isTempParameter);
        }
    
        public virtual int aspnet_Nu_Users_WithFreeUser_Insert(Nullable<System.Guid> applicationId, Nullable<System.Guid> userId, string userName, string loweredUserName, string mobileAlias, Nullable<bool> isAnonymous, Nullable<System.DateTime> lastActivityDate, string eULA_Ver, Nullable<System.DateTime> eULA_Date)
        {
            var applicationIdParameter = applicationId.HasValue ?
                new ObjectParameter("ApplicationId", applicationId) :
                new ObjectParameter("ApplicationId", typeof(System.Guid));
            ...
            var loweredUserNameParameter = loweredUserName != null ?
                new ObjectParameter("LoweredUserName", loweredUserName) :
                new ObjectParameter("LoweredUserName", typeof(string));
    
            var mobileAliasParameter = mobileAlias != null ?
                new ObjectParameter("MobileAlias", mobileAlias) :
                new ObjectParameter("MobileAlias", typeof(string));
    
            var isAnonymousParameter = isAnonymous.HasValue ?
                new ObjectParameter("IsAnonymous", isAnonymous) :
                new ObjectParameter("IsAnonymous", typeof(bool));
    
            var lastActivityDateParameter = lastActivityDate.HasValue ?
                new ObjectParameter("LastActivityDate", lastActivityDate) :
                new ObjectParameter("LastActivityDate", typeof(System.DateTime));
    
            var eULA_VerParameter = eULA_Ver != null ?
                new ObjectParameter("EULA_Ver", eULA_Ver) :
                new ObjectParameter("EULA_Ver", typeof(string));
    
            var eULA_DateParameter = eULA_Date.HasValue ?
                new ObjectParameter("EULA_Date", eULA_Date) :
                new ObjectParameter("EULA_Date", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("aspnet_Nu_Users_WithFreeUser_Insert", applicationIdParameter, userIdParameter, userNameParameter, loweredUserNameParameter, mobileAliasParameter, isAnonymousParameter, lastActivityDateParameter, eULA_VerParameter, eULA_DateParameter);
        }
    
        public virtual int aspnet_Nu_Users_WithFreeUser_Update(Nullable<System.Guid> applicationId, Nullable<System.Guid> userId, string userName, string loweredUserName, string mobileAlias, Nullable<bool> isAnonymous, Nullable<System.DateTime> lastActivityDate, string eULA_Ver, Nullable<System.DateTime> eULA_Date)
        {
            var applicationIdParameter = applicationId.HasValue ?
                new ObjectParameter("ApplicationId", applicationId) :
                new ObjectParameter("ApplicationId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("aspnet_Nu_Users_WithFreeUser_Update", applicationIdParameter, userIdParameter, userNameParameter, loweredUserNameParameter, mobileAliasParameter, isAnonymousParameter, lastActivityDateParameter, eULA_VerParameter, eULA_DateParameter);
        }
        ...
        public virtual ObjectResult<aspnet_SearchUsersFromInsulet_Result> aspnet_SearchUsersFromInsulet(string corporation)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_SearchUsersFromInsulet_Result>("aspnet_SearchUsersFromInsulet", corporationParameter);
        }
        ...
        public virtual int Nu_User_Account_Delete(string userId)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Nu_User_Account_Delete", userIdParameter);
        }
    
        public virtual int Nu_User_Account_Insert(string userId, string firstName, string middleInitial, string lastName)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Nu_User_Account_Insert", userIdParameter, firstNameParameter, middleInitialParameter, lastNameParameter);
        }
    
        public virtual int Nu_User_Account_Update(string userId, string firstName, string middleInitial, string lastName)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Nu_User_Account_Update", userIdParameter, firstNameParameter, middleInitialParameter, lastNameParameter);
        }
    }
}
